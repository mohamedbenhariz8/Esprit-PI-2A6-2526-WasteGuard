...
"text-align: center;"));
        ...
        cbTrier->setMinimumSize(QSize(200, 34));
        cbTrier->setStyleSheet(QString::fromUtf8("color: #333; padding: 4px 8px;"));
        cbTrier->setEditable(false);
...
"Responsable Commercial", nullptr));
        recherche->setPlaceholderText(QCoreApplication::translate("MainWindow", "Rechercher par Matricule...", nullptr));
        lblTrier->setText(QCoreApplication::translate("MainWindow", "Trier par :", nullptr));
        cbTrier->setItemText(0, QCoreApplication::translate("MainWindow", "Type de Contrat", nullptr));
